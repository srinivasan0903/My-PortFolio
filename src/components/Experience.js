...
<div className="experience-content">
  <div className="card-details">
    ...
    <p className="experience-text-title">(Internship: April 2024 – December 2024)</p>
    <p className="text-body">
      I have completed my internship from April 2024 to December 2024, focused on mobile application development with React Native and Android Studio.
    </p>
    <p className="text-body">
